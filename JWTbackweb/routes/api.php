...
// Other API routes without extra /api prefix
...
Route::middleware('jwt.auth')->group(function () {
    ...
    Route::post('/user/update-position', [AuthController::class, 'updatePosition']);
    ...
    Route::get('/appointment/specific', [AppointmentController::class, 'getSpecific']);
