...
import './rescheduleModal.css'; // Reuse BookModal styles
...
const RescheduleConfirmation = ({ onClose }) => {
  console.log("Showing confirmation modal"); // debug
  return (
    ...
    <div className="bookModal">
      <div className="bookModal-box">
        <div className="bookModal-box-in">
          ...
          <section className="bookModal-box-in-cards">
  <pre>{JSON.stringify({ status, date, user }, null, 2)}</pre>
  <AppointmentCardMain status={status} date={date} user={user} />
</section>
     ...
     {/* Confirmation Modal */}
{showConfirmation && (
  <RescheduleConfirmation onClose={handleCloseConfirmation} />
)}
