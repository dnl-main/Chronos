...
const CertificateCard = ({ user, position, uploadedFile, expiryDate }) => {
  return (
    <main className="certificate-cards-card">
      ...
      <section className="certificate-cards-card-profile">
        ...
        <div className="certificate-cards-card-profile-info">
          <p className="certificate-cards-card-profile-info-text">{user}</p>
      ...
      <section className="certificate-cards-card-certificates">
        <div className="certificate-cards-card-certificates-1">
          <div className="certificate-cards-card-certificates-1-text">
            <p className="certificate-cards-card-certificates-1-text-sub">Uploaded File</p>
            <p className="certificate-cards-card-certificates-1-text-heading">
              {uploadedFile ? (
        ...
        <div className="certificate-cards-card-certificates-2">
          <div className="certificate-cards-card-certificates-2-text">
            ...
            <p className="certificate-cards-card-certificates-2-text-heading">
        ...
        {/* Leave certificates-3 and -4 as-is for now unless you want them dynamic too */}
