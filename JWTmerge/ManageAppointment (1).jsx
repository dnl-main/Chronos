...
const ManageAppointment = ({ appointment, user, bookedAppointments = [], onClose }) => {
  ...
  useEffect(() => {
    if (appointment) {
      setSelectedAppointment({
        ...
        crewingDept: appointment.crewingDept || '',
        operator: appointment.operator || '',
        accountingOption: appointment.accountingOption || '',
  ...
  return (
    <>
<div className="editAppointment"> {/* editAppointment */}
<div className="editAppointment-box"> {/* editAppointment-box */}
<div className="editAppointment-box-in"> {/* editAppointment-box-in */}
      ...
      >
        <Close_MD style={{ color: "var(--primary-color)", width: "20px", height: "20px", '--stroke-width': '4px' }} />
      	...
      	<p>Edit Appointment</p>
			</div> {/* editAppointment-box-in-left-header-heading */}
    </div> {/* editAppointment-box-in-left-header */}
        ...
        {bookedAppointments.map((ba) => (
          <ManageAppointmentCard
            ...
            onSelect={() => {
              setSelectedAppointment({
                ...ba,
                start_time: normalizeTime(ba.start_time),
                end_time: normalizeTime(ba.end_time),
              });
              setSelectedUser(ba.user);
            }}
          />
        ))}
      </div> {/* editAppointment-box-in-left-core-bot-cards */}
    </div> {/* editAppointment-box-in-left-core-bot */}
  </div> {/* editAppointment-box-in-left */}
  ...
  <article className="editAppointment-box-in-right-dept-name">
    ...
    <main className="editAppointment-box-in-right-dropdown">
      <article className="editAppointment-box-in-right-dropdown-date">
        ...
        />
      </article> {/* editAppointment-box-in-right-dropdown-date */}
      ...
      <div className="editAppointment-box-in-right-dropdown-time">
          ...
          />
      	</article> {/* editAppointment-box-in-right-dropdown-time-start */}
          ...
          />
      	</article> {/* editAppointment-box-in-right-dropdown-time-end */}
      </div> {/* editAppointment-box-in-right-dropdown-time */}
		</main> {/* editAppointment-box-in-right-dropdown */}
      ...
      >
		...
		</main> {/* editAppointment-box-in-right-buttons */}
  </div> {/* editAppointment-box-in-right */}
</div> {/* editAppointment-box-in */}
</div> {/* editAppointment-box */}
</div> {/* editAppointment */}
